...
import { NavigationGrid, NavigationItem } from '@/components/NavigationGrid';
    ...
    <NavigationGrid className="h-screen bg-tv-bg overflow-hidden">
      <div className="w-full h-full flex flex-col p-3">
        ...
        <header className="flex items-center gap-2 mb-3 flex-shrink-0">
          ...
          {/* Search Input - using NavigationItem for d-pad */}
          <NavigationItem
            row={0}
            col={1}
          ...
          >
            {((isFocused: boolean) => (
              <div 
                className={`flex items-center gap-2 bg-white/10 rounded-lg px-3 py-2 cursor-pointer w-full
